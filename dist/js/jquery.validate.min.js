...
! function (a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            maxlength: a.validator.format("Пожалуйста, введите не более {0} симв."),
            minlength: a.validator.format("Пожалуйста, введите хотя бы {0} симв."),
            rangelength: a.validator.format("Введите значение от {0} до {1} симв."),
            range: a.validator.format("Введите значение от {0} до {1}."),
            max: a.validator.format("Пожалуйста, введите значение меньше или равно {0}."),
            min: a.validator.format("Пожалуйста, введите значение больше или равное {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
